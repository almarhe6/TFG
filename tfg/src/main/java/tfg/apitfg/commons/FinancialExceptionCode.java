...
public enum FinancialExceptionCode {
    ...
    TRANSACTIONS__FINDING_REPOSITORY_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "Error finding transactions from the database"),
    TRANSACTIONS__SAVING_REPOSITORY_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "Error saving transaction from the database"),
    HISTORICAL__FINDING_REPOSITORY_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "Error finding transactions from the database"),
    CREDIT__NOT_ENOUGH_CREDIT_ERROR(HttpStatus.PAYMENT_REQUIRED, "Not enough credit to buy"),
    INVESTMENT_PLAN__SAVING_REPOSITORY_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "Error saving investment plan from the database"),
    INVESTMENT_PLAN__NOT_FOUND_REPOSITORY_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "Error finding investment plan from the database"),
    INVESTMENT_PLAN__ALREADY_EXISTS_REPOSITORY_ERROR(
            HttpStatus.INTERNAL_SERVER_ERROR, "Error finding investment plan from the database"),
